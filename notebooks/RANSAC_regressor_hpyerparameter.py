...
from src.Krizanje import Diagonalno_krizanje, N_tockovno_krizanje, Utezeno_globalno_krizanje
...
max_trials = Urejena_mnozica( "max_trials", list(range(50, 250)), stdev = 8)

geni = [max_trials]

populacija = [{"max_trials": 100}]


output_file = open("RANSAC_regressor_results_correct.txt", "w")
...
for horizon in horizons:
    ...
    kriz = Utezeno_globalno_krizanje()
    alg = EAlgoritem(velikost_populacije = 30, omejitev_stevila_ocenjevanj = 50, stevilo_starsev_za_izbiro = 8,
